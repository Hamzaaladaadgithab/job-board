    ...
    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        ...
        <div class="col-span-full">
          ...
          <div class="mt-2">
            ...
            focus:outline-indigo-500 sm:text-sm/6">{{old('body' , $post->body)}}</textarea>
          </div>
            ...
            <div class="flex gap-3">
              <div class="flex h-6 shrink-0 items-center">
                <div class="group grid size-4 grid-cols-1">
                  <input id="published"  name="published"  type="checkbox" value="1" {{old('published') || (old() && $post->published) ? 'checked' : ''}}  aria-describedby="published-description"
                   class="col-start-1 row-start-1 appearance-none rounded-sm border border-white/10 bg-black/5 checked:border-indigo-500 checked:bg-indigo-500
